package com.huayu.web.platform.image;
...
public class ImageCut {  
    ...
    public static void abscut(String srcImageFile,String dirImageFile, int x, int y, int destWidth,  
            int destHeight) {  
    	abscut(new File(srcImageFile), dirImageFile, x, y, destWidth, destHeight);
    }  
  
	public static void abscut(File imageFile,String dirImageFile, int x, int y, int destWidth,  
            int destHeight){
		try {  
            Image img;  
