DROP DATABASE IF EXISTS huayu_etl;

CREATE DATABASE huayu_etl DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE tb_application_info(
	...
	app_uuid varchar(36) NOT NULL comment 'appplication ID' ,
...
CREATE TABLE tb_app_table(
	...
	partition_ext VARCHAR(500) COMMENT 'partition outside sql ; the column partitions will ignore, if exist the value ' ,
	extract_type TINYINT COMMENT '1: all , 2: increment  ' ,
	table_type TINYINT  comment '1: extendal ; 2: inner ; 3:other',	
	introduce VARCHAR(500) COMMENT 'introduce for it',
	...
	exist_update_extractor TINYINT(1) COMMENT 'boolean for update extract' ,
	specify_update_condition varchar(1000) comment 'specify condition of update' ,
	exist_delete_extractor TINYINT(1) COMMENT 'boolean for delete extract' ,
	specify_delete_condition varchar(1000) comment 'specify condition of delete' ,
...
CREATE TABLE tb_extract_recorder(
	...
	create_user_id BIGINT default 0 COMMENT 'adder user id' , 
	create_date DATETIME default now() COMMENT 'time of add' ,
	update_user_id BIGINT  COMMENT 'updator user id' , 
	update_date DATETIME COMMENT 'time of updator'
)ENGINE=INNODB DEFAULT CHARSET=utf8;
